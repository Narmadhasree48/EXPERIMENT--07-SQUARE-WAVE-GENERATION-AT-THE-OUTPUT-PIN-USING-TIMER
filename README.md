...
## Output screen shots of proteus  :
 ![Screenshot 2024-09-30 134730](https://github.com/user-attachments/assets/f290bd9f-2006-4004-94a4-4dbaebc98e4e)

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![Screenshot 2024-09-30 134521](https://github.com/user-attachments/assets/8b73169b-3163-484e-8e0d-02138c435e4d)

## DUTY CYCLE AND FREQUENCY CALCULATION 
FOR PULSE AT 500
![Screenshot 2024-09-30 133824](https://github.com/user-attachments/assets/f36e8457-602b-421a-85f4-734b480a6c53)
```
TON = 2ms
TOFF=2ms
TOTAL TIME =4ms 
...
```
FOR PULSE AT 700
![Screenshot 2024-09-30 134054](https://github.com/user-attachments/assets/5ecb88c7-240c-4680-b5f3-f7d7aac5dec1)
```
TON = 3ms
TOFF=1ms
TOTAL TIME = 4ms
...
```
FOR PULSE AT 900
![Screenshot 2024-09-30 134323](https://github.com/user-attachments/assets/20f5cecc-d9eb-453b-873a-b0f229f1bbb3)
```
TON = 3.5ms
TOFF=0.5ms
TOTAL TIME =4ms 
